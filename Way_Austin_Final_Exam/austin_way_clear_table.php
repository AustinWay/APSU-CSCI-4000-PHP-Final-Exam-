...
//get how many rows are in database before clearing
$query = 'select count(number) from coordinate';
$statement = $conn->prepare($query);
$statement->execute();
$coordinate = $statement->fetch();
//gets number
$coordinateNumber = $coordinate[0];
$statement->closeCursor();


//clear table in database
//$query = 'truncate table coordinate';
...
<div class="container" id="play-container">
    <div class="row">
        <div class="col-md-12">
            ...
            <hr id="hr">
            <h3><strong><?php echo $coordinateNumber; ?></strong> records were removed from the database table</h3>
